...
//! `OpMeta` initializers for `ops_repo_misc_v`. Referenced by `OPS` in this module's parent.
use crate::meta_types::*;
pub(super) const OP_VALIDATE_ISSUE_CONFIG: OpMeta = OpMeta {
    op_id: "repoValidateIssueConfig",
    group: "repo",
    command: "validate-issue-config",
    method: "GET",
