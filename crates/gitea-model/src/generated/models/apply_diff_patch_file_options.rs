...
//! `ApplyDiffPatchFileOptions`, as declared in the Gitea API specification.
use crate::generated::CommitDateOptions;
use crate::generated::Identity;
use serde::{Deserialize, Serialize};
/// ApplyDiffPatchFileOptions options for applying a diff patch Note: `author` and `committer` are
