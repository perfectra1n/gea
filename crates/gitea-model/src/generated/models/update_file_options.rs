...
//! `UpdateFileOptions`, as declared in the Gitea API specification.
use crate::generated::CommitDateOptions;
use crate::generated::Identity;
use serde::{Deserialize, Serialize};
/// UpdateFileOptions options for updating or creating a file Note: `author` and `committer` are
/// optional (if only one is given, it will be used for the other, otherwise the authenticated user
/// will be used)
...
pub struct UpdateFileOptions {
    ...
    /// from_path (optional) is the path of the original file which will be moved/renamed to the path in
    /// the URL
    #[serde(default, skip_serializing_if = "Option::is_none")]
